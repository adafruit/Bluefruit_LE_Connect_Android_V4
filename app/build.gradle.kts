...
dependencies {
    ...
    // Warning: Paho library is no longer compatible with Android 12+: https://github.com/eclipse/paho.mqtt.android/issues/485
    /*
    ...
    // Image Crop
    implementation("com.naver.android.helloyako:imagecropview:1.2.4")

    //
    testImplementation("junit:junit:4.13.2")


    // Fix kotlin-stdlib duplicate class errors: https://stackoverflow.com/questions/75263047/duplicate-class-in-kotlin-android
    constraints {
